...
force -freeze sim:/main/interrupt_sg 0 0
...
run
force -freeze sim:/main/in_port 1'h100 0
run
force -freeze sim:/main/in_port 1'h300 0
run
force -freeze sim:/main/in_port 1'hFFFFFFFF 0
force -freeze sim:/main/interrupt_sg 1 0
run
force -freeze sim:/main/in_port 1'hFFFFFFFF 0
force -freeze sim:/main/interrupt_sg 0 0
run
force -freeze sim:/main/in_port 1'h200 0
run
run
run
run
